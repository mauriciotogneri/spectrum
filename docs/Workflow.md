...
9. **Validate** — The team verifies that all scenarios in `scenarios.md` are covered by passing tests. Since tests were written during implementation, this phase focuses on confirming completeness — not writing new tests.
